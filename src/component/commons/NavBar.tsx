    ...
    <nav className=" w-full nav-bar sticky top-0 z-[100] bg-transparent py-6 backdrop-blur-sm">
      <div className="container flex items-center justify-between space-x-12 mx-auto px-6 ">
        ...
        <div className="block lg:hidden ">
          ...
          >
            <GiHamburgerMenu className=" w-20 h-8 pl-10 transition focus:outline-none" />
          </button>
          {hamburgerOpen && (
            <div className="absolute top-0 left-0 w-full lg:hidden bg-rpaBlue-900 z-[500] text-white">
              <div className=" gap-8 bg-rpaBlue-500 py-6 flex flex-col shadow-md shadow-blue-500/50">
                <div className=" container mx-auto px-6 flex items-center justify-between ">
                  ...
                  >
                    <GrClose className="h-10 w-10 " aria-hidden="true" />
                  </button>
                </div>
                <div className="container mx-auto px-6 flex flex-col items-start gap-y-4">
                  <Link
                    to="aboutHackathon"
                    activeClass="active"
                    smooth
                  ...
                  <button
                    type="button"
                    className="mx-auto p-6 rounded-lg mt-6 py-3 px-10 font-semibold hover:text-white bg-rpaPurple-500"
                  >
                    CONTACT US
                  </button>
                </div>
